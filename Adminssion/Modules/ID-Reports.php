    ...
    <div class="main-wrapper">
        ...
        <div class="content-area">
            <div class="module-header">
                ...
                <p>Logs and reports for all ID issuances.</p>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>440</td>
                            <td>10</td>
                            <td><button onclick="handleSimpleAction('PDF Download')" style="border: none; background: #1648bc; color: white; padding: 6px 12px; border-radius: 6px; cursor: pointer;">Download PDF</button></td>
                        </tr>
                    </tbody>
                </table>
            </div>

...
<head>
    ...
    <title>Requirement List - Admission</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="content-area">
            <div class="module-header">
                ...
                <p>Manage list of required documents for enrollment.</p>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Original</td>
                            <td>All Freshmen</td>
                            <td><button onclick="handleSimpleAction('Edit Requirement')" style="border: none; background: #e2e8f0; color: #475569; padding: 6px 12px; border-radius: 6px; cursor: pointer;">Edit</button></td>
                        </tr>
                        <tr>

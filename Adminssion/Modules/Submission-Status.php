...
<head>
    ...
    <title>Submission Status - Admission</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="content-area">
            <div class="module-header">
                ...
                <p>Track student document submissions.</p>
            </div>
             ...
             <div class="table-card">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>Emily Clark</td>
                            <td><span style="color: #ef4444;">Good Moral</span></td>
                            <td>3/4</td>
                            <td>Today</td>
                            <td><button onclick="handleSimpleAction('Email Reminder')" style="border: none; background: #1648bc; color: white; padding: 6px 12px; border-radius: 6px; cursor: pointer;">Remind</button></td>
                        </tr>
                    </tbody>
                </table>
            </div>

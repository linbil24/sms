...
<head>
    ...
    <title>Document Review - Admission</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="content-area">
            <div class="module-header">
                ...
                <p>Validate submitted student requirements.</p>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>John Doe</td>
                            <td>Form 137</td>
                            <td><span style="background: #fef3c7; color: #d97706; padding: 4px 10px; border-radius: 20px; font-size: 0.75rem;">Pending Validation</span></td>
                            <td><button onclick="handleSimpleAction('Validation')" style="border: none; background: #1648bc; color: white; padding: 6px 12px; border-radius: 6px; cursor: pointer;">Validate</button></td>
                        </tr>
                    </tbody>
                </table>
            </div>
